// /home/krylon/go/src/github.com/blicero/jazz/database/00_database_main_test.go
// -*- mode: go; coding: utf-8; -*-
// Created on 01. 09. 2026 by Benjamin Walkenhorst
// (c) 2026 Benjamin Walkenhorst
// Time-stamp: <2026-09-01 22:47:37 krylon>
...
func TestMain(m *testing.M) {
	var (
		err     error
		result  int
		baseDir = time.Now().Format("/tmp/jazz_db_test_20060102_150405")
	)
